<template>
  <q-page padding class="my-page">
    <q-toolbar class="bg-blue-grey-4 text-white">
      ...
      <q-toolbar-title> Tarifas </q-toolbar-title>
    </q-toolbar>
    <div class="">
      <q-table
        title=""
      ...
      <q-card style="width: 760px; max-width: 800px">
        ...
        <q-card-section>
          ...
          <div class="row">
            ...
            <div class="col-md-8">
              <div class="text-subtitle2">{{ showItem.value.nombre }}</div>
            </div>
          </div>
        </q-card-section>
...
const tarifas = computed(() => tarifasStore.tarifas)
...
const save = async () => {
  ...
  if (editCreate.value) {
    tarifasStore.updateTarifa(editedItem.value)
  } else {
    tarifasStore.addTarifa(editedItem.value)
  }
  close()
}
...
const deleteItem = (item) => {
  $q.dialog({
    ...
    tarifasStore.deleteTarifa(item)
  })
}
