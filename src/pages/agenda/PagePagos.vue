...
const formatearFecha = (fecha) => {
  ...
  // Formatear la fecha
  const fechaFormateada = date.formatDate(fecha, 'DD/MM/YYYY')
  ...
  return `${fechaFormateada} ${horas}:${minutosFormateados} ${periodo}`
}
...
<style scoped>
/* Asegurar que el header del datepicker sea visible */
:deep(.q-date__header) {
  opacity: 1 !important;
